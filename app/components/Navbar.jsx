...
const Navbar = () => {
    ...
    return (
        ...
        <div style={{
            ...
            {isMobileMenuOpen && (
                <div style={{ position: 'absolute', top: '70px', left: 0, right: 0, backgroundColor: 'rgba(15, 15, 15, 0.95)', backdropFilter: 'blur(16px)', borderRadius: '20px', padding: '16px', border: '1px solid rgba(255,255,255,0.1)' }}>
                    {navItems.map((item, idx) => (
