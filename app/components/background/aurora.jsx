...
export default function Aurora() {
  ...
  useEffect(() => {
    ...
    const renderer = new Renderer({ alpha: false, premultipliedAlpha: false, antialias: true });
    const gl = renderer.gl;
    
    // QuickAi Colors
    const colorStops = ['#000000', '#d946ef', '#06b6d4'];
    ...
    // TRIANGLE REPLACED WITH GEOMETRY
    ...
    const update = t => {
      ...
      program.uniforms.uTime.value = t * 0.001; // Original Animation Speed
